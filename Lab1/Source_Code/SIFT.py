...
img_building = cv2.imread(os.path.join(dataset_path, 'yellow_1.png'))
...
draw_image_matches(orb, 'yellow_1.png', 'yellow_2.jpg')
...
img1, kp1, des1 = image_detect_and_compute(sift, 'yellow_1.png')
img2, kp2, des2 = image_detect_and_compute(sift, 'yellow_2.jpg')
